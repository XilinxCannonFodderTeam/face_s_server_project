...
#     print(img.shape)
#     plt.imshow(img)
    image_to_test_encoding = face_recognition.face_encodings(img)
    if len(image_to_test_encoding) < 1:
        return False
    else:
        image_to_test_encoding = image_to_test_encoding[0]
#     if(image_to_test_encoding.dim is not 3)
